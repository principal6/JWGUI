...
protected:
	virtual JWERROR JWControl::MakeBorder();
	virtual void JWControl::UpdateBorder();
	virtual auto JWControl::IsMouseOnRegion(JW_INT2 MousePosition) const->bool;
...
public:
	...
	// Creation
	virtual auto JWControl::Create(LPDIRECT3DDEVICE9 pDevice, LPD3DXFONT pFont)->JWERROR;
